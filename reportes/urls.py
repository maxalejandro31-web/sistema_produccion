...
urlpatterns = [
    ...
    path("reportes/levantamiento-mp/", views.reporte_levantamiento_mp, name="reporte_levantamiento_mp"),
    path("reportes/movimientos-mp/", views.reporte_movimientos_mp, name="reporte_movimientos_mp"),
    path("reportes/salidas-mp/", views.reporte_salidas_mp, name="reporte_salidas_mp"),
